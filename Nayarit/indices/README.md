# Capa de índices — Nayarit

Índices **derivados** de la biblioteca de Nayarit. No forman parte del acervo: se
generan leyendo `Nayarit/ordenamientos/<id>/actual/` y no modifican ningún
...
consulta a Nayarit abre un archivo que no contiene un solo artículo de otra
...
- 138 ordenamientos, 16,768 artículos de cuerpo y 2,334 transitorios.
- 5,355 notas de reforma ancladas a su artículo, en 106 ordenamientos.
- 19,102 artículos en el índice de búsqueda; 437 aristas de remisión.
